...
Write-Host "Sending discovery payload (with cookie)..."
...
try {
    ...
    if ($response.Content -like "*//OK*") {
        ...
        Write-Host "   Still unauthenticated - tokens may have expired"
        Write-Host "  Get fresh tokens from browser!"
    }
