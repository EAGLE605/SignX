...
async def run_migrations():
    ...
    try:
        print("=" * 60)
        print("RUNNING AISC FOUNDATION MIGRATIONS")
        print("=" * 60)
        ...
        if exists:
            ...
            print(f"[OK] Contains {count} shapes")
            ...
            if not view_exists:
                ...
                print("[OK] Sign-specific views already exist")
            
            # Test the function
            print("\n" + "=" * 60)
            print("TESTING AISC INTEGRATION")
            print("=" * 60)
            ...
            print("\n" + "=" * 60)
            print("AISC FOUNDATION FULLY ACTIVATED!")
            print("=" * 60)
            print("\n✅ Database contains:")
            print(f"  - {count} AISC shapes")
            print("  - Sign-specific views and functions")
            print("  - Material cost tracking")
            print("  - Optimized selection functions")
