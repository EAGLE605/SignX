...
down_revision: str | None = '011_monument'
...
def upgrade() -> None:
    ...
    print("[INFO] Starting restructure to pole architecture...")

    # =====================================================================
    # STEP 1: Drop Monument Tables (Clean Break)
    # =====================================================================

    print("[1/9] Dropping monument tables and references...")
    ...
    print("    ✓ Monument tables dropped")

    # =====================================================================
    # STEP 2: Create New ENUMs
    # =====================================================================

    print("[2/9] Creating enums for pole architecture...")
    ...
    print("    ✓ Enums created: application_type, risk_category, load_distribution_method")

    # =====================================================================
    # STEP 3: Create Single Pole Tables
    # =====================================================================

    print("[3/9] Creating single_pole_configs table...")
    ...
    print("[4/9] Creating single_pole_results table...")
    ...
    print("[5/9] Creating double_pole_configs table...")
    ...
    print("[6/9] Creating double_pole_results table...")
    ...
    print("[7/9] Creating performance indexes...")
    ...
    print("[8/9] Updating projects table references...")
    ...
    print("[9/9] Creating calculation functions and views...")
    ...
    print("    ✓ calculate_asce7_wind_pressure() function created")
    ...
    print("    ✓ optimal_pole_sections view created")

    print("[SUCCESS] Restructure to pole architecture complete!")
    print("")
    print("Summary:")
    print("  • Dropped: monument_configs, monument_analysis_results")
    print("  • Created: single_pole_configs, single_pole_results")
    print("  • Created: double_pole_configs, double_pole_results")
    print("  • Created: calculate_asce7_wind_pressure() function")
    print("  • Created: optimal_pole_sections view")
    print("  • Updated: projects table with pole references")


def downgrade() -> None:
    """Revert to monument architecture (for rollback)."""

    print("[INFO] Rolling back to monument architecture...")
    ...
    print("[INFO] Downgrade complete - would need to re-run 011_monument migration to restore monument tables")
